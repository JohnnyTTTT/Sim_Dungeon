Shader "CrossSectionHDRP/LitTessellation"
{
    Properties
    {
        ...
        [HideInInspector] _CullModeShadows("__cullmodeShadows", Float) = 0
        [Toggle(BACKFACE_SHADOWS)] _backfaceShadows("backfaceShadows", Float) = 0
		// CrossSection
	...
	#pragma multi_compile_fragment __ CLIP_PLANE CLIP_SPHERE CLIP_BOX CLIP_CORNER CLIP_NONE CLIP_SPHERE_OUT CLIP_PIE
	//#pragma multi_compile_local_fragment __ CLIP_PLANE CLIP_PIE CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX // to get enumerated keywords as local.
	#pragma shader_feature_local_fragment INVERSE
	// CrossSection
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#include "ApplyMeshModification.hlsl"
			#endif
    ...
    CustomEditor "Rendering.HighDefinition.CS_LitGUI"
}
