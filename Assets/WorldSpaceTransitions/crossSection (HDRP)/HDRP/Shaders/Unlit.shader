Shader "CrossSectionHDRP/Unlit"
{
    Properties
    {
		...
		[Toggle(RETRACT_BACKFACES)] _retractBackfaces("retractBackfaces", Float) = 0// to do
		// CrossSection
    }
    ...
    CustomEditor "Rendering.HighDefinition.CS_UnlitGUI"
}
