	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float temp_output_15_0 = ( distance( max( ( abs( ( PositionWS - float3( 0,0,0 ) ) ) - ( float3( 1,1,1 ) * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / 0.0 );
				...
				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = temp_output_15_0;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_15_0 = ( distance( max( ( abs( ( ase_positionWS - float3( 0,0,0 ) ) ) - ( float3( 1,1,1 ) * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / 0.0 );
...
ASEEND*/
//CHKSM=F5253C6B9329FE021D977BFCE62D5279C62AED80