...
namespace Johnny.SimDungeon
{
    public class LandManagementItemViewModel : ButtonViewModel<StructureMode>
    {
        ...
        {
            BindingService.MainPanelViewModel.StructureMode = item;
        }
    }
    public class LandManagementItemView : ViewBase<LandManagementItemViewModel>
    {
        ...
        {
            staticBindingSet.Bind(this).For(v => v.isCurrentMode).ToExpression(() => BindingService.MainPanelViewModel.StructureMode == m_BingdingedStructureMode).OneWay();
        }
